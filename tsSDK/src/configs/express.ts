...
export const SUBACCOUNT_MESSAGE =
  "Generate a PerpEx 1CT (One-Click Trading) session. Only sign this message on a trusted website.";
export const SUBACCOUNT_DOCS_URL =
  "https://docs.perpex.ai/docs/trading/v2/#one-click-trading";
...
const GAS_PAYMENT_TOKENS: Record<ContractsChainId, string[]> = {
  ...
  [CELO]: [
    getTokenBySymbol(CELO, "USDC").address,
    getTokenBySymbol(CELO, "WETH").address,
    getTokenBySymbol(CELO, "CELO").address,
  ],
  [AVALANCHE]: [
