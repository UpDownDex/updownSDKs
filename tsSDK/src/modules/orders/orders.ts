...
import {
  ...
  WrapOrUnwrapParams,
} from "./transactions/createWrapOrUnwrapTxn";
import {
...
export class Orders extends Module {
  ...
  async createDecreaseOrder({
    ...
    // Determine receive token based on swap type
    // If swap type is SwapCollateralTokenToPnlToken, receive token should be pnlToken
    // Otherwise, receive token is collateralToken
