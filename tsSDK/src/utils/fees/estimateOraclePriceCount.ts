// @see https://github.com/perpex/gmx-synthetics/blob/6ed9be061d8fcc0dc7bc5d34dee3bf091408a1bf/contracts/gas/GasUtils.sol#L218-L234
...
export function estimateGlvDepositOraclePriceCount(
  marketCount: bigint,
  swapsCount = 0n
) {
...
export function estimateGlvWithdrawalOraclePriceCount(
  marketCount: bigint,
  swapsCount = 0n
) {
  return 2n + marketCount + swapsCount;
